 ...
 */
public class TvTopRated extends Fragment {

    public static final String API_KEY = "0ce7227febd49ffdf2da55d1c5aa607f";
    public static final String TAG = TvPopular.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<TvShowsResponse> call = apiService.getTopRatedSeries(API_KEY);
